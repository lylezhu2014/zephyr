...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_version_info {
	uint8_t  status;
...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_supported_commands {
	uint8_t  status;
	uint8_t  commands[64];
} STRUCT_PACKED_POST;

#define BT_HCI_OP_VS_READ_SUPPORTED_FEATURES	BT_OP(BT_OGF_VS, 0x0003)
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_supported_features {
	uint8_t  status;
	uint8_t  features[8];
} STRUCT_PACKED_POST;

#define BT_HCI_OP_VS_SET_EVENT_MASK             BT_OP(BT_OGF_VS, 0x0004)
STRUCT_PACKED_PRE struct bt_hci_cp_vs_set_event_mask {
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_reset {
	uint8_t  type;
} STRUCT_PACKED_POST;

#define BT_HCI_OP_VS_WRITE_BD_ADDR              BT_OP(BT_OGF_VS, 0x0006)
STRUCT_PACKED_PRE struct bt_hci_cp_vs_write_bd_addr {
	bt_addr_t bdaddr;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_set_trace_enable {
	uint8_t  enable;
	uint8_t  type;
} STRUCT_PACKED_POST;

#define BT_HCI_OP_VS_READ_BUILD_INFO            BT_OP(BT_OGF_VS, 0x0008)
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_build_info {
	uint8_t  status;
	uint8_t  info[0];
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_hci_vs_static_addr {
	bt_addr_t bdaddr;
	uint8_t      ir[16];
} STRUCT_PACKED_POST;

#define BT_HCI_OP_VS_READ_STATIC_ADDRS          BT_OP(BT_OGF_VS, 0x0009)
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_static_addrs {
	uint8_t   status;
	uint8_t   num_addrs;
...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_key_hierarchy_roots {
	uint8_t  status;
	uint8_t  ir[16];
	uint8_t  er[16];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_chip_temp {
	uint8_t  status;
	int8_t  temps;
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_hci_vs_cmd {
	uint16_t vendor_id;
...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_host_stack_cmds {
	uint8_t   status;
	uint8_t   num_cmds;
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_set_scan_req_reports {
	uint8_t  enable;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_write_tx_power_level {
	uint8_t  handle_type;
	uint16_t handle;
	int8_t  tx_power_level;
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_hci_rp_vs_write_tx_power_level {
	uint8_t  status;
	uint8_t  handle_type;
	uint16_t handle;
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_read_tx_power_level {
	uint8_t  handle_type;
	uint16_t handle;
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_tx_power_level {
	uint8_t  status;
	uint8_t  handle_type;
	uint16_t handle;
	int8_t  tx_power_level;
...
STRUCT_PACKED_PRE struct bt_hci_rp_vs_read_usb_transport_mode {
	uint8_t  status;
...
STRUCT_PACKED_PRE struct bt_hci_cp_vs_set_usb_transport_mode {
	uint8_t  mode;
} STRUCT_PACKED_POST;

/* Events */

STRUCT_PACKED_PRE struct bt_hci_evt_vs {
	uint8_t  subevent;
} STRUCT_PACKED_POST;

#define BT_HCI_EVT_VS_FATAL_ERROR              0x02
STRUCT_PACKED_PRE struct bt_hci_evt_vs_fatal_error {
	uint64_t pc;
	uint8_t  err_info[0];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_evt_vs_trace_info {
	uint8_t  type;
	uint8_t  data[0];
} STRUCT_PACKED_POST;

#define BT_HCI_EVT_VS_SCAN_REQ_RX              0x04
STRUCT_PACKED_PRE struct bt_hci_evt_vs_scan_req_rx {
	bt_addr_le_t addr;
	int8_t         rssi;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_mesh {
	uint8_t         opcode;
} STRUCT_PACKED_POST;

#define BT_HCI_OC_MESH_GET_OPTS                0x00
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_get_opts {
	uint8_t      status;
	uint8_t      opcode;
	uint8_t      revision;
	uint8_t      ch_map;
...
STRUCT_PACKED_PRE struct bt_hci_mesh_pattern {
	uint8_t pattern_len;
	uint8_t pattern[0];
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_hci_cp_mesh_set_scan_filter {
	uint8_t      scan_filter;
	uint8_t      filter_dup;
	uint8_t      num_patterns;
	struct    bt_hci_mesh_pattern patterns[0];
} STRUCT_PACKED_POST;
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_set_scan_filter {
	uint8_t      status;
	uint8_t      opcode;
	uint8_t      scan_filter;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_mesh_advertise {
	uint8_t      adv_slot;
...
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_advertise {
	uint8_t      status;
	uint8_t      opcode;
	uint8_t      adv_slot;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_mesh_advertise_timed {
	uint8_t      adv_slot;
	uint8_t      own_addr_type;
	bt_addr_t random_addr;
	uint8_t      ch_map;
...
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_advertise_timed {
	uint8_t      status;
	uint8_t      opcode;
	uint8_t      adv_slot;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_mesh_advertise_cancel {
	uint8_t      adv_slot;
} STRUCT_PACKED_POST;
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_advertise_cancel {
	uint8_t      status;
	uint8_t      opcode;
	uint8_t      adv_slot;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_hci_cp_mesh_set_scanning {
	uint8_t      enable;
	uint8_t      ch_map;
	uint8_t      scan_filter;
} STRUCT_PACKED_POST;
STRUCT_PACKED_PRE struct bt_hci_rp_mesh_set_scanning {
	uint8_t      status;
	uint8_t      opcode;
} STRUCT_PACKED_POST;

/* Events */
STRUCT_PACKED_PRE struct bt_hci_evt_mesh {
	uint8_t  prefix;
	uint8_t  subevent;
} STRUCT_PACKED_POST;

#define BT_HCI_EVT_MESH_ADV_COMPLETE           0x00
STRUCT_PACKED_PRE struct bt_hci_evt_mesh_adv_complete {
	uint8_t         adv_slot;
} STRUCT_PACKED_POST;

#define BT_HCI_EVT_MESH_SCANNING_REPORT        0x01
STRUCT_PACKED_PRE struct bt_hci_evt_mesh_scan_report {
	bt_addr_le_t addr;
	uint8_t         chan;
	int8_t         rssi;
	uint32_t        instant;
...
STRUCT_PACKED_PRE struct bt_hci_evt_mesh_scanning_report {
	uint8_t num_reports;
