...
STRUCT_PACKED_PRE struct bt_l2cap_hdr {
	uint16_t len;
	uint16_t cid;
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_l2cap_sig_hdr {
	uint8_t  code;
	uint8_t  ident;
	uint16_t len;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_cmd_reject {
	uint16_t reason;
	uint8_t  data[0];
} STRUCT_PACKED_POST;

STRUCT_PACKED_PRE struct bt_l2cap_cmd_reject_cid_data {
	uint16_t scid;
	uint16_t dcid;
} STRUCT_PACKED_POST;

#define BT_L2CAP_CONN_REQ               0x02
STRUCT_PACKED_PRE struct bt_l2cap_conn_req {
	uint16_t psm;
	uint16_t scid;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_conn_rsp {
	uint16_t dcid;
	uint16_t scid;
	uint16_t result;
	uint16_t status;
...
STRUCT_PACKED_PRE struct bt_l2cap_conf_req {
	uint16_t dcid;
	uint16_t flags;
	uint8_t  data[0];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_conf_rsp {
	uint16_t scid;
	uint16_t flags;
	uint16_t result;
	uint8_t  data[0];
...
STRUCT_PACKED_PRE struct bt_l2cap_conf_opt {
	uint8_t type;
	uint8_t len;
	uint8_t data[0];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_disconn_req {
	uint16_t dcid;
	uint16_t scid;
} STRUCT_PACKED_POST;

#define BT_L2CAP_DISCONN_RSP            0x07
STRUCT_PACKED_PRE struct bt_l2cap_disconn_rsp {
	uint16_t dcid;
	uint16_t scid;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_info_req {
	uint16_t type;
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_info_rsp {
	uint16_t type;
	uint16_t result;
	uint8_t  data[0];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_conn_param_req {
...
STRUCT_PACKED_PRE struct bt_l2cap_conn_param_rsp {
	uint16_t result;
} STRUCT_PACKED_POST;

#define BT_L2CAP_LE_CONN_REQ            0x14
STRUCT_PACKED_PRE struct bt_l2cap_le_conn_req {
	uint16_t psm;
	uint16_t scid;
	uint16_t mtu;
	uint16_t mps;
...
STRUCT_PACKED_PRE struct bt_l2cap_le_conn_rsp {
	uint16_t dcid;
	uint16_t mtu;
	uint16_t mps;
	uint16_t credits;
...
STRUCT_PACKED_PRE struct bt_l2cap_le_credits {
	uint16_t cid;
	uint16_t credits;
} STRUCT_PACKED_POST;

#define BT_L2CAP_ECRED_CONN_REQ         0x17
STRUCT_PACKED_PRE struct bt_l2cap_ecred_conn_req {
	uint16_t psm;
	uint16_t mtu;
	uint16_t mps;
	uint16_t credits;
...
STRUCT_PACKED_PRE struct bt_l2cap_ecred_conn_rsp {
	uint16_t mtu;
	uint16_t mps;
	uint16_t credits;
	uint16_t result;
...
STRUCT_PACKED_PRE struct bt_l2cap_ecred_reconf_req {
	uint16_t mtu;
	uint16_t mps;
	uint16_t scid[0];
} STRUCT_PACKED_POST;
...
STRUCT_PACKED_PRE struct bt_l2cap_ecred_reconf_rsp {
	uint16_t result;
} STRUCT_PACKED_POST;
