...
ENUM_PACKED enum bt_rfcomm_cfc {
...
STRUCT_PACKED struct bt_rfcomm_hdr {
	uint8_t address;
	uint8_t control;
	uint8_t length;
} STRUCT_UNPACKED;
...
STRUCT_PACKED struct bt_rfcomm_msg_hdr {
	uint8_t type;
	uint8_t len;
} STRUCT_UNPACKED;

#define BT_RFCOMM_PN    0x20
STRUCT_PACKED struct bt_rfcomm_pn {
	uint8_t  dlci;
	uint8_t  flow_ctrl;
	uint8_t  priority;
	uint8_t  ack_timer;
...
STRUCT_PACKED struct bt_rfcomm_msc {
	uint8_t  dlci;
	uint8_t  v24_signal;
} STRUCT_UNPACKED;
...
STRUCT_PACKED struct bt_rfcomm_rls {
	uint8_t  dlci;
	uint8_t  line_status;
} STRUCT_UNPACKED;

#define BT_RFCOMM_RPN   0x24
STRUCT_PACKED struct bt_rfcomm_rpn {
	uint8_t  dlci;
	uint8_t  baud_rate;
